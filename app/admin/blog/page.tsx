            ...
            {posts.map((post) => (
              <div key={post.id} className="flex items-center gap-4 p-4">
                <div className="flex-1 min-w-0">
                  <p className="font-bold text-sm text-[#1d2353] truncate">{post.title}</p>
                ...
                <form action={togglePublishAction}>
                  ...
                  <button
                    type="submit"
                    className={`text-[10px] font-bold px-2.5 py-1 rounded-full uppercase shrink-0 transition-colors ${
