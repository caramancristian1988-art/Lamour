...
const defaultFeatures = [
  { title: "Evaluare rapidă", desc: "Identificăm nevoia reală în cel mai scurt timp posibil.", icon: "search" },
  { title: "Resurse potrivite", desc: "Recomandăm exclusiv soluții verificate și adaptate.", icon: "wrench" },
  { title: "Continuitate garantată", desc: "Toate recomandările sunt urmărite în timp.", icon: "shield" },
  { title: "Suport dedicat", desc: "Suntem disponibili pentru orice întrebare ulterioară.", icon: "support" },
];

const defaultInclus = [
  "Evaluare completă a situației",
  "Identificarea nevoilor prioritare",
  "Recomandare de resurse potrivite",
  "Legătură cu specialiștii potriviți",
  "Urmărire după evaluare și continuitate",
];

const defaultPasi = [
  { nr: "01", title: "Apel & programare", desc: "Ne descrii situația și stabilim împreună o întâlnire de evaluare.", img: "/IMG_2838.PNG" },
  { nr: "02", title: "Diagnosticare", desc: "Identificăm exact nevoia și îți prezentăm soluțiile potrivite.", img: "/IMG_2840.PNG" },
  { nr: "03", title: "Reparație", desc: "Punem în practică soluția aleasă și verificăm împreună rezultatul.", img: "/IMG_2848.PNG" },
];

const defaultTestimoniale = [
  { text: "Au evaluat situația chiar în aceeași zi! Persoana care m-a ajutat a fost foarte profesionistă și a explicat tot ce a făcut.", name: "Radu M.", city: "Chișinău", initials: "RM" },
  { text: "Transparență totală. Au prezentat soluțiile disponibile înainte de a începe și le-au respectat.", name: "Ioana S.", city: "Bălți", initials: "IS" },
  { text: "Am sunat dimineața și după-amiaza totul funcționa. Recomand cu toată încrederea!", name: "Doru N.", city: "Chișinău", initials: "DN" },
];
  ...
  return (
    <div className="bg-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[340px] lg:min-h-[440px]">
          <div className="flex flex-col justify-center px-5 sm:px-6 lg:px-12 py-10 lg:py-12 bg-background">
            <nav aria-label="Fir de ariadnă" className="flex items-center gap-1.5 text-xs sm:text-sm text-muted-foreground mb-5">
              ...
              <span aria-hidden>›</span>
              <span className="text-foreground font-medium">Evaluare & diagnosticare</span>
            </nav>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight tracking-tight mb-4 text-primary">
              Evaluare & <span className="text-accent">diagnosticare</span>
            </h1>
            <p className="text-sm sm:text-base text-foreground/80 leading-relaxed max-w-sm mb-8">
              Evaluăm rapid orice situație și identificăm împreună soluțiile potrivite nevoilor tale.
            </p>
            <div className="flex items-center gap-3 flex-wrap">
              <Button asChild variant="accent" size="lg">
                <Link href="/contact">Solicită evaluare</Link>
              </Button>
              <Button asChild variant="outline" size="lg">
                <Link href="/servicii/diagnosticare#detalii">Vezi detalii</Link>
              </Button>
            </div>
          </div>
      ...
      <section id="detalii" className="max-w-7xl mx-auto px-5 sm:px-6 py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-2xl lg:text-3xl font-bold text-primary leading-snug tracking-tight mb-4">
            Identificăm rapid soluția potrivită
          </h2>
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Echipa noastră evaluează fiecare situație cu atenție, de la nevoile imediate până la
            resursele pe termen lung. Lucrăm transparent și rămânem alături de tine pentru fiecare
            pas următor.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-6 py-10">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-primary tracking-tight mb-8">Pașii evaluării</h2>
        ...
        <div className="bg-primary rounded-2xl px-6 sm:px-8 py-8 sm:py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <p className="text-white font-bold text-xl lg:text-2xl leading-snug max-w-xs">
              Ai o situație care are nevoie de evaluare?
            </p>
            <p className="text-white/70 text-sm mt-2">Contactează-ne acum și găsim rapid o soluție.</p>
          </div>
