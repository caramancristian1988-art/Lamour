...
const defaultFeatures = [
  { title: "Capacitate extinsă", desc: "Programe dimensionate pentru instituții, companii și autorități publice.", icon: "building" },
  { title: "Planificare personalizată", desc: "Evaluăm nevoile organizației și propunem un plan adaptat.", icon: "blueprint" },
  { title: "Colaborare pe termen lung", desc: "Parteneriate durabile, cu urmărire constantă a rezultatelor.", icon: "clock-alt" },
  { title: "Echipă specializată", desc: "Consultanți cu experiență în proiecte instituționale complexe.", icon: "users" },
];

const defaultInclus = [
  "Evaluarea nevoilor de accesibilitate ale instituției",
  "Plan de acțiune personalizat pentru organizație",
  "Implementare împreună cu echipa specializată",
  "Verificare completă a rezultatelor",
  "Parteneriat de colaborare continuă",
];

const defaultPasi = [
  { nr: "01", title: "Audit tehnic", desc: "Evaluăm contextul, nevoile și cerințele specifice instituției tale.", img: "/IMG_2842.PNG" },
  { nr: "02", title: "Proiectare", desc: "Concepem planul de acțiune optim pentru organizația ta.", img: "/IMG_2839.PNG" },
  { nr: "03", title: "Implementare", desc: "Punem în practică planul și verificăm complet rezultatele.", img: "/IMG_2840.PNG" },
];

const defaultTestimoniale = [
  { text: "Au evaluat și propus un plan de accesibilitate pentru biroul nostru fără nicio problemă. Echipă foarte profesionistă.", name: "Andrei P.", city: "Chișinău", initials: "AP" },
  { text: "Parteneriatul cu echipa lor funcționează impecabil de la început.", name: "Olesea D.", city: "Bălți", initials: "OD" },
  { text: "Colaborarea continuă ne-a scutit de bătăi de cap, totul e urmărit periodic.", name: "Mihai R.", city: "Chișinău", initials: "MR" },
];
  ...
  return (
    <div className="bg-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[340px] lg:min-h-[440px]">
          <div className="flex flex-col justify-center px-5 sm:px-6 lg:px-12 py-10 lg:py-12 bg-background">
            <nav aria-label="Fir de ariadnă" className="flex items-center gap-1.5 text-xs sm:text-sm text-muted-foreground mb-5">
              ...
              <span aria-hidden>›</span>
              <span className="text-foreground font-medium">Parteneriate instituționale</span>
            </nav>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight tracking-tight mb-4 text-primary">
              Parteneriate <span className="text-accent">instituționale</span>
            </h1>
            <p className="text-sm sm:text-base text-foreground/80 leading-relaxed max-w-sm mb-8">
              Soluții de accesibilitate pentru instituții, companii, autorități publice și
              parteneri comunitari.
            </p>
            <div className="flex items-center gap-3 flex-wrap">
              <Button asChild variant="accent" size="lg">
                <Link href="/contact">Devino partener</Link>
              </Button>
              <Button asChild variant="outline" size="lg">
                <Link href="/servicii/comerciale#detalii">Vezi detalii</Link>
              </Button>
            </div>
          </div>
      ...
      <section id="detalii" className="max-w-7xl mx-auto px-5 sm:px-6 py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-2xl lg:text-3xl font-bold text-primary leading-snug tracking-tight mb-4">
            Accesibilitate pentru organizația ta
          </h2>
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Colaborăm cu instituții, companii și autorități publice pentru a dezvolta soluții
            de accesibilitate potrivite fiecărui context, cu accent pe rezultate durabile și
            colaborare continuă.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-6 py-10">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-primary tracking-tight mb-8">Pașii parteneriatului</h2>
      ...
      {/* ── TESTIMONIALE ── */}
      <section className="max-w-7xl mx-auto px-5 sm:px-6 py-10">
        <p className="text-xs font-bold tracking-widest uppercase text-accent mb-2">Ce spun partenerii noștri</p>
        <h2 className="text-2xl sm:text-3xl font-bold text-primary tracking-tight mb-8">Mărturii de la instituții partenere</h2>
        ...
        <div className="bg-primary rounded-2xl px-6 sm:px-8 py-8 sm:py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <p className="text-white font-bold text-xl lg:text-2xl leading-snug max-w-xs">
              Reprezinți o instituție sau companie?
            </p>
            <p className="text-white/70 text-sm mt-2">Solicită o evaluare gratuită pentru un parteneriat de accesibilitate.</p>
          </div>
