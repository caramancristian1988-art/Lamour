...
export default function InstalareePage() {
  return (
      ...
      <section id="detalii" className="max-w-7xl mx-auto px-4 sm:px-6 py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="flex items-stretch gap-0 rounded-2xl overflow-hidden shadow-md border border-gray-100">
          <div className="relative w-1/2 shrink-0">
            <Image src="/IMG_2848.PNG" alt="Unitate externă AC" fill className="object-cover object-center" />
          </div>
          ...
          {produse.map((p) => (
            <div key={p.brand + p.model} className="rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow bg-white flex flex-col">
              <div className="relative h-44 bg-gray-50">
                ...
                <span className="absolute top-3 left-3 bg-[#c7092b] text-white text-[11px] font-bold px-2.5 py-1 rounded-md">
                  {p.discount}
                </span>
              </div>
              <div className="p-4 flex flex-col gap-1 flex-1">
                ...
                <div className="flex items-center gap-2 mt-4">
                  <Link
                    href={p.href}
                    className="flex-1 flex items-center justify-center gap-2 bg-[#c7092b] hover:bg-[#a5071f] text-white text-xs font-bold py-2.5 px-3 rounded-xl transition-colors"
                  >
                  ...
                  <Link
                    href={p.href}
                    className="w-10 h-10 flex items-center justify-center border border-gray-200 rounded-xl hover:border-[#c7092b] hover:text-[#c7092b] text-gray-400 transition-colors shrink-0"
                  >
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
