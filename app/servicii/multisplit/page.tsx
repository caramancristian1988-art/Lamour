...
const produse = [
  { brand: "GREE", model: "Multi Pular 4x9.000 BTU", specs: "Inverter, Clasa A++", price: "24.499 MDL", oldPrice: "27.999 MDL", discount: "-13%", href: "/produse/gree-pular" },
  { brand: "MIDEA", model: "Multi Mission 3x12.000 BTU", specs: "Inverter, Clasa A++", price: "21.899 MDL", oldPrice: "24.999 MDL", discount: "-12%", href: "/produse/midea-mission" },
  { brand: "AUX", model: "Multi Freedom 4x9.000 BTU", specs: "Inverter, Clasa A++", price: "23.499 MDL", oldPrice: "26.499 MDL", discount: "-11%", href: "/produse/aux-freedom" },
  { brand: "TOSOT", model: "Multi Seiya 3x12.000 BTU", specs: "Inverter, Clasa A++", price: "22.999 MDL", oldPrice: "25.999 MDL", discount: "-12%", href: "/produse/tosot-seiya" },
];
    ...
    <div className="bg-white text-[#1d2353]">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 min-h-[420px]">
        ...
        <div className="relative min-h-[280px] lg:min-h-0">
          <Image src="/IMG_2843.PNG" alt="Sisteme multisplit" fill className="object-cover object-center" priority />
        </div>
      </section>
