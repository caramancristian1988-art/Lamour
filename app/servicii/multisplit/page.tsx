...
const defaultFeatures = [
  { title: "Un singur punct de contact", desc: "Coordonăm mai multe forme de sprijin printr-o singură echipă.", icon: "grid" },
  { title: "Program adaptat", desc: "Fiecare persoană are propriul plan și ritm de sprijin.", icon: "clock-alt" },
  { title: "Utilizare eficientă a resurselor", desc: "Combinăm resursele disponibile pentru rezultate mai bune.", icon: "bolt" },
  { title: "Abordare discretă", desc: "Un singur plan integrat, fără demersuri repetate și birocrație.", icon: "home" },
];

const defaultInclus = [
  "Consultanță pentru identificarea nevoilor multiple",
  "Coordonarea mai multor forme de sprijin",
  "Punct unic de contact pentru fiecare persoană",
  "Verificare completă a planului integrat",
  "Continuitate pentru toate serviciile combinate",
];

const defaultPasi = [
  { nr: "01", title: "Evaluare", desc: "Stabilim toate nevoile și tipurile de sprijin necesare.", img: "/IMG_2843.PNG" },
  { nr: "02", title: "Montaj", desc: "Punem în practică fiecare formă de sprijin identificată.", img: "/IMG_2839.PNG" },
  { nr: "03", title: "Configurare", desc: "Stabilim urmărirea individuală și testăm fiecare componentă a planului.", img: "/IMG_2840.PNG" },
];

const defaultTestimoniale = [
  { text: "Programul integrat a fost perfect pentru situația mea. Un singur punct de contact pentru tot ce aveam nevoie!", name: "Tatiana B.", city: "Chișinău", initials: "TB" },
  { text: "Coordonare rapidă, fără bătăi de cap. Fiecare nevoie a fost tratată exact cum voiam.", name: "Igor C.", city: "Bălți", initials: "IC" },
  { text: "Recomand cu încredere programele integrate, mai ales atunci când ai nevoie de mai multe forme de sprijin.", name: "Natalia S.", city: "Chișinău", initials: "NS" },
];
  ...
  return (
    <div className="bg-background">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[340px] lg:min-h-[440px]">
          <div className="flex flex-col justify-center px-5 sm:px-6 lg:px-12 py-10 lg:py-12 bg-background">
            <nav aria-label="Fir de ariadnă" className="flex items-center gap-1.5 text-xs sm:text-sm text-muted-foreground mb-5">
              ...
              <span aria-hidden>›</span>
              <span className="text-foreground font-medium">Programe integrate de sprijin</span>
            </nav>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight tracking-tight mb-4 text-primary">
              Programe <span className="text-accent">integrate de sprijin</span>
            </h1>
            <p className="text-sm sm:text-base text-foreground/80 leading-relaxed max-w-sm mb-8">
              Combinăm mai multe forme de sprijin într-un singur plan, coordonat printr-un
            ...
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <Button asChild variant="outline" size="lg">
                <Link href="/servicii/multisplit#detalii">Vezi detalii</Link>
              </Button>
            </div>
          </div>
      ...
      <section id="detalii" className="max-w-7xl mx-auto px-5 sm:px-6 py-12 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-2xl lg:text-3xl font-bold text-primary leading-snug tracking-tight mb-4">
            Sprijin coordonat, într-un singur loc
          </h2>
          <p className="text-sm sm:text-base text-muted-foreground leading-relaxed">
            Programele integrate permit combinarea mai multor forme de sprijin printr-un singur
            punct de contact, oferind o experiență mai simplă și mai eficientă pentru fiecare
            persoană sprijinită.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-5 sm:px-6 py-10">
        ...
        <h2 className="text-2xl sm:text-3xl font-bold text-primary tracking-tight mb-8">Pașii programului integrat</h2>
        ...
        <div className="bg-primary rounded-2xl px-6 sm:px-8 py-8 sm:py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div>
            <p className="text-white font-bold text-xl lg:text-2xl leading-snug max-w-xs">
              Ai nevoie de mai multe forme de sprijin?
            </p>
            <p className="text-white/70 text-sm mt-2">Solicită un plan integrat, personalizat pentru situația ta.</p>
          </div>
