...
export default function ProductCard({
  ...
  return (
    <div className="group bg-white rounded-2xl border border-gray-200 overflow-hidden h-full flex flex-col transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
      {/* Image area */}
      <div className="relative h-[180px] sm:h-[240px] lg:h-[280px] flex items-center justify-center bg-white overflow-hidden">
        ...
        {/* Badge */}
        {displayBadge && (
          <span className="absolute top-4 left-4 bg-[#c7092b] text-white text-xs font-bold rounded-md px-3 py-1 uppercase tracking-wide">
            {displayBadge}
          </span>
        )}
