  ...
  return (
    <div className="bg-[#1d2353] text-white text-xs py-2 px-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        <div className="hidden sm:flex items-center gap-1.5 sm:ml-16">
          ...
          <span>Transport gratuit pentru comenzi peste 1500 MDL</span>
        </div>
        <div className="flex items-center gap-4 sm:gap-10 sm:mr-24 ml-auto sm:ml-0">
