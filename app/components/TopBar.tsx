  ...
  return (
    <div className="bg-[#1d2353] text-white text-xs py-2 px-4">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4">
        ...
        <div className="flex items-center gap-3 sm:gap-10 sm:mr-24 shrink-0">
          <a href="tel:+37369000000" className="flex items-center gap-1 sm:gap-1.5 hover:text-[#c7092b] transition-colors text-[10px] sm:text-xs whitespace-nowrap">
          ...
          <a href="mailto:contact@climatrapid.md" className="hidden sm:flex items-center gap-1.5 hover:text-[#c7092b] transition-colors">
